...
class SessionStaticAccumlator extends AccumulatorV2[String,mutable.HashMap[String,Int]]{
  ...
  override def copy(): AccumulatorV2[String, mutable.HashMap[String, Int]] = {
    ...
    val value = new SessionStaticAccumlator

    value.countMap ++= this.countMap
  ...
  override def merge(other: AccumulatorV2[String, mutable.HashMap[String, Int]]): Unit = {
    ...
    other match {
     case acc:SessionStaticAccumlator => {
